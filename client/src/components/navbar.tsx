      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link href="/track-status" className="text-text-dark hover:text-primary font-medium transition-colors" data-testid="nav-track">Track Status</Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200" data-testid="mobile-menu">
            <div className="px-4 py-2 space-y-2">
              ...
              <Link href="/track-status" className="block py-3 text-text-dark hover:text-primary font-medium" onClick={() => setIsMenuOpen(false)} data-testid="mobile-nav-track">Track Status</Link>
